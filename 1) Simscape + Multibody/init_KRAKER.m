%% KRAKER E-trailer parameter file
%  last updated: 28/10/2024

%% Model Parameters

% KRAKER Trailer Parameters:
mass_trailer =      7350;       %[kg] Mass of the Trailer
chassis_length =    10.36;      %[m] Length of trailer chassis
front_overhang =    1.305;      %[m] Distance between kingpin and front of trailer
wheelbase =         5.584;      %[m] Distance between kingpin and centre of axle combination

% Electric drivetrain masses:
mass_batterypack =  420;        %[kg] mass of battery pack
mass_Emotor =       48;         %[kg] mass of E-motor
mass_inverter =     6.8;        %[kg] mass of inverter
mass_Edriveline = mass_batterypack + mass_Emotor + mass_inverter;
...
initialSOC =        0.65;       %[%] Starting SOC

% E-Motor (AXM4) Parameters:
MaxTrqOut =         950;        %[Nm] Max E-motor Torque
MaxPowerOut =       430000;     %[W] Max Power of E-motor
MaxMotorSpeed =     4500;       %[rpm] Maximum motor speed
Std_Regen_Trq =     300;        %[Nm] Standard Regeneration Torque when throttle = 0
    
% Driveline Parameters:
G_diff =            6;          %Gear ratio of E-trailer differential
G_motor =           1;          %Gear ratio of motor reducer (no motor reducer)
